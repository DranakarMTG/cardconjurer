...
var ptBounds = {x:1507/2010, y:2630/2814, width:364/2010, height:180/2814};
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//text
	loadTextOptions({
		mana: {name:'Mana Cost', text:'',x:-0.011, y:0.648, width:0.9292, height:71/2100, oneLine:true, size:0.038, align:'right', shadowX:-0.001, shadowY:0.0029, manaCost:true, manaPrefix:'breakingNews', manaSpacing:0},
		title: {name:'Title', text:'', x:0.33, y:0.65, width:0.35, height:0.12, oneLine:false, font:'Beardsons', size:4.5, align:'center', color:'#4f3821', shadowX:-0.001, shadowY:0.0005, lineSpacing: 0.4},
		type: {name:'Type Left', text:'', x:0.08, y:0.70, width:0.22, height:0.113, oneLine:false, font:'CarnevaleeFreakshow', size:0.032, color:'#4f3821', align:'center', shadowX:-0.001, shadowY:0.0002},
		type2: {name:'Type Right', text:'SUBTYPE HERE!', x:0.71, y:0.70, width:0.22, height:0.113, oneLine:false, font:'CarnevaleeFreakshow', size:0.032, color:'#4f3821', align:'center', shadowX:-0.001, shadowY:0.0002},
		rules: {name:'Rules Text', text:'', x:0.063, y:0.785, width:0.88, height:0.195, size:0.034, font:'decour'},
		pt: {name:'Power/Toughness', text:'', x:0.775, y:0.944, width:0.15, height:0.06, size:0.032, font:'Beardsons', oneLine:true, align:'center', kerning: 0.018}
	});
		//bottom info
	await loadBottomInfo({
		topLeft: {text:'{fontbelerenbsc}{fontsize' + scaleHeight(0.001) + '}{upinline' + scaleHeight(0.0005) + '}\uFFEE{savex2} {elemidinfo-artist}', x:0.07, y:0.67, width:0.98, height:0.0177, oneLine:true, font:'decour', size:0.0177, color:'#4f3821'},
